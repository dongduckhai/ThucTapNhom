...
// dùng 3 cái phía dưới là chủ yếu
// Lấy ra một phẩn tử trong CSDL
...
function db_update($table, $data, $where) {
    /* data là 1 mảng các giá trị cần thay đổi và giá trị mới của chúng */
    global $conn;
    $sql = "";
    foreach ($data as $field => $value) {
        if ($value === NULL)
